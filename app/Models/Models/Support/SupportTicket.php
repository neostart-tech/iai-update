...
class SupportTicket extends Model
{
    ...
    {
        // L'informaticien peut tout voir
        if ($user->hasRole('Informaticien')) {
            return true;
        }
        
        // Sinon, seulement son propre ticket
        return $this->ticketable_type === User::class && $this->ticketable_id === $user->id;
    }
}