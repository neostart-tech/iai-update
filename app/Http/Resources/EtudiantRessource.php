...
class EtudiantRessource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'statut' => ($this->relationLoaded('fraisEtudiant') ? $this->fraisEtudiant->contains('est_en_abandon', true) : $this->fraisEtudiant()->where('est_en_abandon', true)->exists()) ? 'abandon' : ($this->statut ?? 'actif'),
            'est_bloque' => $this->statut === 'bloque' || ($this->relationLoaded('fraisEtudiant') ? $this->fraisEtudiant->contains('est_en_abandon', true) : $this->fraisEtudiant()->where('est_en_abandon', true)->exists()),
            'est_en_abandon' => $this->relationLoaded('fraisEtudiant') ? $this->fraisEtudiant->contains('est_en_abandon', true) : $this->fraisEtudiant()->where('est_en_abandon', true)->exists(),
            'peut_composer' => $this->statut !== 'bloque' && !($this->relationLoaded('fraisEtudiant') ? $this->fraisEtudiant->contains('est_en_abandon', true) : $this->fraisEtudiant()->where('est_en_abandon', true)->exists()),
