...
use App\Http\Controllers\EtudiantAuth\NewPasswordController;
use App\Http\Controllers\EtudiantAuth\PasswordController;
use App\Http\Controllers\EtudiantAuth\PasswordResetLinkController;
use App\Http\Controllers\EtudiantAuth\VerifyEmailController;
...
Route::prefix('espace-etudiant')->name('api.etudiants.')->group(function () {
    ...
    Route::controller(AuthenticatedSessionController::class)->name('auth.')->prefix('me-connecter')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::controller(EvaluationController::class)->prefix('evaluation')->name('evaluation.')->group(function () {
            Route::get('liste', 'getListEvaluationForStudent')->name('liste');
            Route::get('start/{id}/index', 'startEvaluationview')->name('start-view');
            Route::post('/etudiant/evaluation/{id}/submit',  'submitQuestion')->name('evaluation.submit');
            Route::post('/evaluation/{id}/autosave', 'autosave')->name('evaluation.autosave');
        });
