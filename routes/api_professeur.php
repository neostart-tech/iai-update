...
Route::controller(AuthentificationSessionController::class)
    ->name('auth.')
    ->prefix('me-connecter')
    ->group(function () {
...
Route::controller(EspaceProfesseurControleur::class)
    ->group(function () {
        ...
        Route::get('presence/{emploi_du_temps_id}/export', function ($emploi_du_temps_id) {
            ...
            return Excel::download(new \App\Exports\CoursAttendanceExport($cours, $emploi), 'recap_presence.xlsx');
...
// Route::middleware('auth:enseignants')
Route::controller(NoteEntryController::class)
    ->prefix('notes')
    ->name('notes.')
    ->group(function () {
