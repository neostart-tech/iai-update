        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h5>Évaluations / Examens / Devoirs</h5>
                </div>
                <div class="card-body">
...
@section('other-js')
    ...
    <a title="Voir les soumissions" href="/espace-enseignant/evaluations/${item.extendedProps.emploi_du_temps_id}/student-evaluation-submission/index" 
       class="btn btn-sm btn-success">
        <i class="ti ti-eye"></i> 
    </a>
    
    <a title="Créer les questions" href="/espace-enseignant/evaluations/${item.extendedProps.emploi_du_temps_id}/create-question-evaluation" 
