									...
									<div style="Margin-left: 20px;Margin-right: 20px;">
										<div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
											<h1 class="size-28 text-justify"
												...
												lang="x-size-28">
												<strong>{{ $mailTitle ?? "Bienvenue au sein de l'administration de IAI-Togo" }}</strong>
											</h1>
								...
								<td>
									<div class="column js-footer-additional-info"
										...
										<div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
											...
											<!-- <div class="email-footer__additional-info"
													 style="font-size: 12px;line-height: 19px;margin-bottom: 18px;margin-top: 0px;">
												<div><p class="email-flexible-footer__additionalinfo--center" style="Margin-top: 0;Margin-bottom: 0;"><a href="https://new.iai-togo.tg" target="_blank">Site Officiel</a></p></div>
											</div> -->
