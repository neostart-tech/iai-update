...
'breadcrumbs' => ['Mon dossier', 'Mes informations'],
])
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                    ...
                    <div class="accordion-body row">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" id="nom" class="form-control" value="{{ $etudiant->nom }}"
                                readonly>
                        </div>

                        <div class="form-group col-12 col-md-6">
                            <label for="prenom" class="form-label">Prénom </label>
                            <input type="text" id="prenom" class="form-control" value="{{ $etudiant->prenom }}"
                                readonly>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" id="nom_jeune_fille" class="form-control"
                                value="{{ $etudiant->nom_jeune_fille }}" readonly>
                        </div>

                        <div class="form-group col-12 col-md-6">
                            <label for="genre" class="form-label">Genre </label>
                            <input type="text" id="genre" class="form-control" value="{{ $etudiant->genre }}"
                                readonly>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" id="date_naissance" class="form-control"
                                value="{{ $etudiant->date_naissance->translatedFormat('d F Y') }}" readonly>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" id="tel" class="form-control" value="{{ $etudiant->tel }}"
                                readonly>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" id="nationalite" class="form-control"
                                value="{{ $etudiant->nationalite }}" readonly>
                        </div>

                        <div class="form-group col-12 col-md-6">
                            <label for="pb" class="form-label">Boîte postale </label>
                            <input type="text" id="pb" class="form-control" value="{{ $etudiant->pb }}"
                                readonly>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" id="fax" class="form-control" value="{{ $etudiant->fax }}"
                                readonly>
                        </div>
                ...
                <div class="accordion-body row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" id="responsable_nom" class="form-control"
                            value="{{ $etudiant->responsable->nom ? $etudiant->responsable->nom : 'Non définie' }}"
                            readonly>
                    </div>
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" id="responsable_tel" class="form-control"
                            value="{{ $etudiant->responsable->tel }}" readonly>
                    </div>
            ...
            <div id="flush-collapseThree" class="accordion-collapse collapse"
                ...
                <div class="accordion-body row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" id="responsable_nom" class="form-control"
                            value="{{ $etudiant->tuteur->nom }}" readonly>
                    </div>

                    <div class="form-group col-12 col-md-6">
                        <label for="tuteur_prenom" class="form-label">Prénom(s) </label>
                        <input type="text" id="responsable_prenom" class="form-control"
                            value="{{ $etudiant->tuteur->prenom }}" readonly>
                    </div>
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" id="responsable_email" class="form-control"
                            value="{{ $etudiant->tuteur->email }}" readonly>
                    </div>

                    <div class="form-group col-12 col-md-6">
                        <label for="tuteur_tel" class="form-label">Téléphone </label>
                        <input type="text" id="responsable_tel" class="form-control"
                            value="{{ $etudiant->tuteur->tel }}" readonly>
                    </div>

                    <div class="form-group col-12 col-md-6">
                        <label for="tuteur_adresse" class="form-label">Adresse </label>
                        <input type="text" id="responsable_adresse" class="form-control"
                            value="{{ $etudiant->tuteur->adresse }}" readonly>
                    </div>
            ...
            <div id="flush-collapseFour" class="accordion-collapse collapse"
                ...
                <div class="accordion-body row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" id="filiere" class="form-control"
                            value="{{ $etudiant->etudiantGroups->first()->filiere->nom }}" readonly>
                    </div>

                    <div class="form-group col-12 col-md-6">
                        <label for="niveau" class="form-label">Niveau</label>
                        <input type="text" id="niveau" class="form-control"
                            value="{{ $etudiant->etudiantGroups->first()->niveau->libelle }}" readonly>
                    </div>

                    <div class="form-group col-12 col-md-6">
                        <label for="groupe" class="form-label">Groupe </label>
                        <input type="text" id="groupe" class="form-control"
                            value="{{ $etudiant->etudiantGroups->first()->niveau->libelle }} {{ $etudiant->etudiantGroups->first()->group->nom }}" readonly>
                    </div>
