...
<body>
        ...
        <div class="page">
            ...
            <div class="student-info" style="margin-top: 20px;">
                <table cellpadding="6" cellspacing="0" style="color: white; width: 100%;">
                    <tr>
                        <td><strong>Nom:</strong> {{ strtoupper($data['user']['nom']) }}</td>
                        <td><strong>Prénom:</strong> {{ $data['user']['prenom'] }}</td>
                        <td><strong>Sexe:</strong> {{ $data['user']['genre'] }}</td>
                    </tr>
                    <tr>
                        <td><strong>Période:</strong> {{ $data['periode_nom'] }}</td>
                        <td><strong>Année académique:</strong> {{ $data['anne'] }}</td>
                        <td><strong>Filière:</strong> Maintenance Informatique et Réseau</td>
                    </tr>
                </table>
            </div>
    ...
    ">
        ...
        ">
            ...
            <!-- NOTES -->
            @foreach ($data['releve_grouped'] as $ueNom => $uvs)
                <div class="ue-section">
                    <div class="ue-header">{{ $ueNom }} ({{ $uvs[0]['credit'] ?? 0 }} crédits)</div>
                    <table>
                        <thead>
                            <tr>
                                <th>Matière</th>
                ...
                <table class="summary-table" role="table" aria-describedby="resume-summary-left">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data['total_credits_valides'] }}</td>
                        </tr>
                        <tr>
                            <th scope="row">Total Crédits Non Validés</th>
                            <td>{{ $data['total_credits_non_valides'] }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($data['moyenne_generale'] >= 16)
                                    Excellent
                                @elseif ($data['moyenne_generale'] >= 14)
                                    Très Bien
                                @elseif ($data['moyenne_generale'] >= 12)
                                    Bien
                                @elseif ($data['moyenne_generale'] >= 10)
                                    Assez Bien
                                @else
                                    Insuffisant
                                @endif
            ...
            <div style="width: 100%; margin-top: 80px;">
                <div style="float: right; text-align: right;">
                    ...
                    <p style="margin: 30px 0 0 0; font-size: 14px;"><strong>Le Chargé des études et de la scolarité</strong></p>
                    <p style="margin: 2px 0 0 0; font-size: 14px;"><strong><u>ADEDJO Justin</u></strong></p>
                </div>
            </div>
