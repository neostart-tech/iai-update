                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Définissez si ces frais s'appliquent à un genre
                                    spécifique</small>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control" rows="2"
                                    placeholder="Ex: Frais spéciaux pour les étudiantes..."></textarea>
                            </div>
                        </div>
                ...
                <form method="POST" id="editFraisForm">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="edit_genre" class="form-label">Genre <span
                                ...
                                <td class="text-center">
                                    <ul class="list-inline me-auto mb-0">
                                        ...
                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip"
                                            ...
                                            <a href="{{ route('comptable.frais.show', $f->id) }}"
