    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
               Voulez-vous vraiment supprimer cette filiere ? Veuillez noter que cette action est irréversible. Continuer ?
            </div>
            <div class="modal-footer">
                <form action="{{route('admin.ues.delete')}}" method="post">
                    @csrf
                    @method('DELETE')
                    <input type="hidden" id='idue' name="idue">
