    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" id="calendar-create_event-close_button" class="btn-close" data-bs-dismiss="modal"
                ...
                <form id="new-event-form">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="salle-nom" class="form-control" value="{{ $group->nom }}"
                                readonly>
                        </div>
                        <input type="hidden" name="salle_id" value="{{ $group->slug }}" id="create-grade-id">
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" data-trigger name="create_grade_id" id="create-salle-id">
                        ...
                        {{-- <div class="form-group col-md-6">
                            ...
                            @if ($teachers->count() < 0)
                                <select class="form-control" data-trigger name="create_teacher_id"
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <button id="handle-event-create-submit-form" type="submit" class="btn btn-secondary"
                                data-pc-action="add">
