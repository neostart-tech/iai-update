            ...
            <table id="dom-jquery" class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$group->niveau->libelle}} {{ $group->nom }}</td>
                        <td>
                            @if($group->filieres->isNotEmpty())
...
<script>
    function displayEditModal(group) {
        ...
        document.getElementById('exampleModalCenterTitle').innerHTML = "Formulaire de modification d'un groupe";
    }
    ...
    function refreshForm() {
        document.getElementById('exampleModalCenterTitle').innerHTML = 'Formulaire de création d\'un groupe';
