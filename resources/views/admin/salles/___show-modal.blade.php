    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Voulez-vous vraiment supprimer cette salle ? Veuillez noter que cette action est irréversible.
                Continuer ?
            </div>
            <div class="modal-footer">
                <form action="{{route('admin.salles.delete')}}" method="POST"> 
                    @csrf
                    @method('DELETE')
                   <input type="hidden"  id="deleteSalleForm"  name="deleteSalleForm">
