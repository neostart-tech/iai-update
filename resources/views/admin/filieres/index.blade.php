            ...
            <table id="dom-jquery" class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $filiere->nom }}</td>
                        @if(AppGetters::getAfficherChoixDate())
                        <td>@foreach ($filiere->anneesScolaires as $annee)
                            {{ $annee->pivot->date_debut ? date_format(date_create($annee->pivot->date_debut),'d F Y') : 'Aucune date définie' }}
                            @endforeach
                        </td>
                        <td>@foreach ($filiere->anneesScolaires as $annee)
                            {{ $annee->pivot->date_fin ? date_format(date_create($annee->pivot->date_fin),'d F Y') : 'Aucune date définie' }}
                            @endforeach
                        </td>
                        @endif
