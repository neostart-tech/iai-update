  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content" style="max-height: 90vh; overflow-y: auto;">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Relevé de note</h1>
...
<script>
  const releveliste = async (id) => {
    const url = `/administration/releves/${id}`;
  ...
  function printReleve() {
    const printContents = document.getElementById("releveToPrint").innerHTML;
