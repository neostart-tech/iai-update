					...
					<div class="accordion-body row">
						...
						<div class="form-group col-12 col-md-6">
							...
							<input type="text" id="date_naissance" class="form-control"
								value="{{$etudiant->date_naissance ? $etudiant->date_naissance->translatedFormat('d F Y') : '--' }}"
								readonly>
						</div>
...
<div class="form-group col-12 col-md-6">
			...
			<div class="form-group col-12 col-md-6">
				<x-forms.label for="filiere" content="Filiere" required="0" />
				<input class="form-control" type="text" value="{{ $etudiant->etudiantGroups->first()->filiere->nom ?? '--' }}" id="filiere" readonly>
			</div>
			<div class="form-group col-12 col-md-6">
				<x-forms.label for="groupe" content="Groupe" required="0" />
				<input class="form-control" type="text" value="{{$etudiant->etudiantGroups->first()->niveau->libelle}} {{ $etudiant->etudiantGroups->first()->group->nom ?? '--' }}" id="groupe" readonly>
			</div>
			<div class="form-group col-12 col-md-6">
				<x-forms.label for="Niveau" content="Niveau" required="0" />
				<input class="form-control" type="text" value="{{$etudiant->etudiantGroups->first()->niveau->libelle  ?? '--' }}" id="niveau" readonly>
			</div>
