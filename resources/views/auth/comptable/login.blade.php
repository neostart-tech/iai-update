...
@section('content')
	...
	<form action="{{ route('comptable.auth.storecompta') }}" method="post">
		@csrf
		...
		<h4 class="text-center f-w-500 mb-3">Entrez vos identifiants pour vous accéder à votre espace comptabilité</h4>
