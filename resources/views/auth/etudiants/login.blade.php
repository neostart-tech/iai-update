...
@section('content')
	...
	<form action="{{ route('etudiants.auth.store') }}" method="post">
		@csrf
		<div class="text-center mb-3">
			<a href="{{ route('home') }}" class="b-brand mx-auto">
				...
				<span class="text-warning text-2xl" style="letter-spacing: 5px; padding-top: 15px; font-weight: bold">&nbsp;&nbsp;&nbsp;{{ AppGetters::getAppName() }}</span>
			</a>
		</div>
		<h4 class="text-center f-w-500 mb-3">Entrez vos identifiants pour vous accéder à votre espace étudiant</h4>
