...
<head>
	...
	<title>{{AppGetters::getAppName()  }}</title>  
	<!--[if !mso]><!-->
			...
			<div role="banner">
				...
				<div class="header"
					...
					<div class="logo emb-logo-margin-box"
							 style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px; align-items:center">
						{{-- <div class="logo-center align-items:center" id="emb-email-header"><img
								style="display: block;height: auto;width: 100%;border: 0;max-width: 179px;"
								src="{{Storage::url(AppGetters::getAppLogo()) ? Storage::url(AppGetters::getAppLogo()) : asset(path: config('images.mails.default',true)) }}" alt="Logo"
								width="179"/></div> --}}
					</div>
					<!--[if mso]></td></tr></table><![endif]-->
				</div>
				...
				<div class="layout one-col fixed-width stack"
					...
					<div class="layout__inner"
						...
						<div class="column"
							...
							<div style="Margin-left: 20px;Margin-right: 20px;">
								<div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
									<h1 class="size-28 text-justify"
											style="Margin-top: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 24px;line-height: 32px" align='center'
											lang="x-size-28">
										<strong>{{ $mailTitle ?? "Bienvenue au sein de l'administration de ".' '.AppGetters::getAppName()}}</strong></h1>
							...
							@isset($buttonText)
								<div style="Margin-left: 20px;Margin-right: 20px;">
									<div class="btn btn--flat " style="margin-bottom: -40px;" align='center'>
										<a
										...
										<div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
											<div class="email-footer__additional-info"
												...
												<div bind-to="address"><p class="email-flexible-footer__additionalinfo--center"
																									style="Margin-top: 0;Margin-bottom: 0;">{{AppGetters::getAppName() ? AppGetters::getAppName() : env('APP_NAME') }}, Lom&#233;,
														Togo</p>
												</div>
											</div>
											<div class="email-footer__additional-info"
