    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Voulez-vous vraiment supprimer ce partenaire ? Veuillez noter que cette action est irréversible.
                Continuer ?
            </div>
            <div class="modal-footer">
                <form action="{{ route('admin.advertisers.delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <input type="text" id='partenaireId' name="partenaireId">
